...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_content">
				<br />
				<form method="post" action="{{route('blogs.store')}}" class="form-horizontal form-label-left">
					@csrf
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<textarea rows="10" name="description" class="resizable_textarea form-control"></textarea>
						</div>
					</div>
					<div class="form-group">
